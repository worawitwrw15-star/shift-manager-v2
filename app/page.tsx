      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <section className="bg-slate-900/75 backdrop-blur-xl rounded-3xl border border-slate-800 p-6 sm:p-8 space-y-6 shadow-2xl">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-slate-800 pb-5">
            ...
            {/* UI ปุ่มเรียงกันในบรรทัดเดียวกันตามแนวลูกศร */}
            <div className="flex flex-nowrap items-center gap-2.5 w-full md:w-auto overflow-x-auto pb-1 md:pb-0">
              <button
                onClick={handleRotateTasks}
                disabled={rotating || tasks.length === 0}
                className="flex-1 md:flex-none flex items-center justify-center gap-1.5 bg-amber-500/10 hover:bg-amber-500/20 text-amber-400 border border-amber-500/30 disabled:opacity-50 px-3.5 py-2 rounded-xl text-xs font-semibold transition-all whitespace-nowrap h-10"
              ...
              <button
                ...
                disabled={cloning}
                className="flex-1 md:flex-none flex items-center justify-center gap-1.5 bg-indigo-500/10 hover:bg-indigo-500/20 text-indigo-300 border border-indigo-500/30 disabled:opacity-50 px-3.5 py-2 rounded-xl text-xs font-semibold transition-all whitespace-nowrap h-10"
              ...
              <button
                ...
                className="flex-1 md:flex-none flex items-center justify-center gap-1.5 bg-emerald-600 hover:bg-emerald-500 text-white px-4 py-2 rounded-xl text-xs font-bold transition-all shadow-lg shadow-emerald-600/25 whitespace-nowrap h-10"
              >
